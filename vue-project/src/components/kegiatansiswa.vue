<template>
    <main class="bg-white inline-flex shadow-2xl p-10">
        <div class="overflow-x-auto">
            <table class="min-w-3xs border border-gray-300">
                <thead class="bg-gray-200 text-gray-700">
                    <tr>
                        <th class="border px-7 py-2">Nama Kegiatan</th>
                        <th class="border px-7 py-2">Mulai</th>
                        <th class="border px-7 py-2">Selesai</th>
                        <th class="border px-7 py-2">Keterangan</th>
                        <!-- <th class="border px-10 py-2">Aksi</th> -->
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="user in users" :key="user.id" class="hover:bg-gray-100">
                        <td class="border px-7 py-2">{{ user.nama }}</td>
                        <td class="border px-7 py-2">{{ user.hari_jam }}</td>
                        <td class="border px-7 py-2">{{ user.selesai }}</td>
                        <td class="border px-7 py-2">{{ user.keterangan }}</td>
